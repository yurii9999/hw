...
public final class FirstPartTasks {
    ...
    public static Map<Artist, List<String>> groupByArtistMapName(Stream<Album> albums) {
        return albums.collect(Collectors.groupingBy(album -> album.getArtist(), Collectors.mapping(album -> album.getName(), Collectors.toList())));
    }
    ...
    public static List<Album> sortByAverageRating(Stream<Album> albums) {
        return albums
                .sorted(Comparator
                        .comparingDouble(album -> - album // sorting by reducing order = sorting by increasing order of opposite numbers
                                .getTracks()
                                .stream()
                                .mapToInt(track -> track.getRating())
                                .average()
    ...
    public static <R> Stream<R> filterIsInstance(Stream<?> s, Class<R> clazz) {
        return s
                .filter(el -> clazz.isAssignableFrom(el.getClass()))
                .map(el -> (R)el);
    }
}